...
const Footer: React.FC = () => {
  ...
  const links = {
    ...
    legal: [
      ...
      { name: legalLinks[2], href: "/refund-policy" },
    ],
  };
  ...
  return (
    <footer className="bg-gradient-to-b from-gray-900 to-gray-950 text-white relative">
      ...
      <div className="address mb-3 w-full flex items-center justify-center flex-col gap-2 px-3">
            <div className="flex items-center justify-center gap-5">
              <p className="text-gray-500 text-lg font-bold">
                Official Mail:
              </p>
              <Link to="mailto:Info@ainurtures.com" className="text-gray-400 text-sm">
          Info@ainurtures.com
              </Link>
            </div>
            ...
            <div className="flex items-center justify-center gap-5">
              ...
              <Link to="tel:+918076468709" className="text-gray-400 text-sm">
          +918076468709
              </Link>
            </div>
           ...
           i - 376, Hari Nagar Extn, Badarpur, New Delhi, 110044, India
              </span>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center space-x-6">
              ...
              <Link
                ...
                className="text-gray-500 hover:text-gray-300 text-xs transition-colors duration-200"
              >
                {t("Landing.footerSec.bottomBar.refundLink")}
              </Link>
            </div>
          </div>
        </div>
